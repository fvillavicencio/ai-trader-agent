...
console.log('INFO', `OpenAI analysis using data directory: ${DATA_DIR}`);
 ...
 * @param {Array} rawData - Raw geopolitical risk data to analyze
 * @returns {Promise<Object>} - Analyzed geopolitical risk data
 */
async function analyzeGeopoliticalRisks(rawData) {
  try {
    logger.info('Starting OpenAI analysis of geopolitical risks...');
    
    // Use the provided raw data
    const inputData = rawData;
    
    if (!inputData || !Array.isArray(inputData)) {
      throw new Error('Invalid input data: expected an array of geopolitical risks');
    }
    ...
    // Return the analyzed data instead of saving to file
