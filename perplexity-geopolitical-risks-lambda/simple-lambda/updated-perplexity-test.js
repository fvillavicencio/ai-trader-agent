// Updated script to test Perplexity API with correct model
...
async function testPerplexityAPI() {
  try {
    ...
    // Following the exact format from Perplexity documentation with correct model
    const response = await axios({
      ...
      data: {
        model: 'llama-3-8b-instruct',  // Using a supported model
        messages: [
          {
            role: 'system',
