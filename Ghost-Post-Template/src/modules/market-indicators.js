...
const addFearGreedIndex = (mobiledoc, data) => {
  ...
  const chartHtml = `
    <div style="margin-top: 20px;">
      ...
      <div style="position: relative; height: 180px; background-color: #fff; border-radius: 8px; padding: 20px 20px 45px 20px; margin-top: 15px; margin-bottom: 25px; display: flex; justify-content: center;">
        <!-- Background color bands (horizontal) with proper scale alignment -->
        <div style="position: absolute; top: 20px; left: 20px; right: 20px; bottom: 45px; height: ${chartHeight}px;">
        ...
        <div style="position: absolute; bottom: 5px; left: 20px; right: 20px; display: flex; height: 30px;">
          ${dataPoints.map(point => `
