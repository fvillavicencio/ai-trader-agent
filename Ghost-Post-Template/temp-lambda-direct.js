...
const createLambdaPayload = () => {
  ...
  return {
    ...
    ghostApiKey: process.env.GHOST_API_KEY || "67f457a5f41c9900013e1e47:44daf1e666349bde96fad6f9a65979ba1d0b11b161a5c765847218f5bd263b7c",
...
// Run the test
invokeLambda()
  .then(() => console.log('Lambda invocation completed successfully'))
  .catch(err => console.error('Lambda invocation failed:', err.message));
