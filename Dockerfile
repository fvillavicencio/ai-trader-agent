...
COPY sp500-analyzer/package*.json ./
RUN apt-get update && \
...
COPY sp500-analyzer/lambda.js ./
COPY sp500-analyzer/analyzeSP500.js ./
COPY sp500-analyzer/services ./services
COPY sp500-analyzer/forward_eps_estimates.json ./
COPY sp500-analyzer/services/sp-500-eps-est.xlsx ./services/
