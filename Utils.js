...
function saveToGoogleDrive(filename, content) {
  try {
    // Get folder name from Script Properties, or use default if not set
    const props = PropertiesService.getScriptProperties();
    const folderName = props.getProperty('OUTPUT_FOLDER_NAME') || 'Market Pulse Daily';
    
    Logger.log(`Saving ${filename} to folder: ${folderName}`);
